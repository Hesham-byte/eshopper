            ...
            <div className="container-fluid pt-5">
                ...
                <div className="row px-xl-5 pb-3">
                    {featureds.length === 0 ? (
                        ...
                        featureds.map((featuredProduct, index) => (
                            <div className="col-lg-3 col-md-6 col-sm-12 pb-1" key={featuredProduct.id}>
                                <div className="card product-item border-0 mb-4">
                                    <div
                                        className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                        <img className="img-fluid w-100" src={featuredProduct.image} alt=""/>
                                    </div>
                                    <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                        <h6 className="text-truncate mb-3">{featuredProduct.name}</h6>
